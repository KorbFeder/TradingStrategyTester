...
//
//export class CypterBStrategy implements IStrategy {
//	usesDynamicExit: boolean = false;
//	calculate(data: OHLCV[], exchange?: Exchange, symbol?: string, timeframe?: Timeframe, since?: number, limit?: number): Promise<TradeDirection> {
...
//
//
//	rsimfi(_period, _multiplier, _tf) {
